...
interface IFundStaking {
     ...
     */
    error FundStaking__AlreadyShutdown();
     ...
     */
    error FundStaking__ContractKilled();
     ...
     */
    error FundStaking__InvalidLockValue(uint256 lock);
     ...
     */
    error FundStaking__MinimumDeposit(uint256 amount, uint256 minimumDeposit);
     ...
     */
    error FundStaking__NoDeposit(uint256 depositId);
     ...
     */
    error FundStaking__NotUnbonding(uint256 depositId);
     ...
     */
    error FundStaking__AlreadyUnbonding(uint256 depositId);
     ...
     */
    error FundStaking__StakeLocked(uint256 depositId);

    /**
     * @notice User attempted to stake zero amount.
     */
    error FundStaking__ZeroDeposit();
